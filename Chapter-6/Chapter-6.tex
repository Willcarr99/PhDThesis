...
The final form of the differential cross-section ratio $R$ in the center-of-mass system becomes
\begin{equation}
...
\subsection{Global Optical Model Normalization} \label{subsec:global_norm}
