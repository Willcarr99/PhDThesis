...
While Ref. \cite{Iliadis2016} simultaneously sampled the reaction rate probability densities of all the reactions in the network, they did not investigate the effect of individual reaction rates. Ref. \cite{Dermigny2017} investigated the sensitivity of the acceptable $T$--$\rho$ conditions for NGC 2419 polluter stars on unknown systematic effects of individual reaction rates. They considered only the reactions important to the synthesis and destruction of both magnesium and potassium, namely reactions comprising the Ne--Na, Mg--Al, and Ar--K nucleosynthesis chains. Only 4 reactions were found to make a significant impact on the acceptable $T$--$\rho$ conditions, $^{30}\mathrm{Si}(p,\gamma)^{31}\mathrm{P}$, $^{37}\mathrm{Ar}(p,\gamma)^{38}\mathrm{K}$, $^{38}\mathrm{Ar}(p,\gamma)^{39}\mathrm{K}$, and $^{39}\mathrm{K}(p,\gamma)^{40}\mathrm{Ca}$. If the reaction rates of $^{30}\mathrm{Si}(p,\gamma)^{31}\mathrm{P}$ and $^{39}\mathrm{K}(p,\gamma)^{40}\mathrm{Ca}$ were each systematically larger than their recommended rates, even as little as a factor of 5, the acceptable $T$--$\rho$ band in Fig. \ref{fig:Trho_Iliadis} would have significantly reduced scatter and would be constrained to the low-temperature side for all densities. In contrast, if they were systematically smaller by a factor of 5, the solutions would have increased scatter.

%if the $^{37}\mathrm{Ar}(p,\gamma)^{38}\mathrm{K}$ and $^{38}\mathrm{Ar}(p,\gamma)^{39}\mathrm{K}$ reaction rates were each systematically
