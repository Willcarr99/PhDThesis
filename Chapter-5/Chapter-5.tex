...
\node at (0,0) {\includegraphics[width=6.5in]{Chapter-5/figs/Eu152_Spectrum.png}};
\node at (0.5,-4.8) {\rlap{$Q_{\mathrm{Long}}$}};
\node[rotate=90] at (-8.5,-0.5) {\rlap{Counts}};
\end{tikzpicture}
